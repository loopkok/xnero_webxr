...
VR_INPUT_MODE = _config_data.get("vr", {}).get("input_mode", "controller")
...
class XNeroWebVRConfig:
    ...
    vr_input_mode: str = VR_INPUT_MODE  # "controller" | "hand" | "both"
